...
export interface PlayerEvents {
    ...
    // Request a fresh I-frame from the device (e.g. after the decode pipeline
    // was rebuilt following a background/foreground switch).
    'need-key-frame': undefined;
}
...
export abstract class BasePlayer extends TypedEmitter<PlayerEvents> {
    ...
    public setScreenInfo(screenInfo: ScreenInfo): void {
        ...
        if (this.parentElement) {
            // On mobile (narrow screens), skip inline width/height so flex layout controls sizing
