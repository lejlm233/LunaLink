    ...
    return {
        module: {
            rules: [
                ...
                {
                    test: /\.svg$/,
                    exclude: /images[\\/]icon\.svg$/,
                    loader: 'svg-inline-loader',
                },
                {
                    // PWA manifest icon — emit as a standalone file (not inlined)
                    test: /images[\\/]icon\.svg$/,
                    use: [
                        {
                            loader: 'file-loader',
                            options: {
                                name: 'images/icon.svg',
                            },
                        },
                    ],
                },
                {
                    // PWA manifest — emit as a standalone JSON file (not parsed as a module)
